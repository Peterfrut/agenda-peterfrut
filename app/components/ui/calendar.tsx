...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      formatters={{
        formatCaption: (month) =>
          format(month, "MMMM 'de' yyyy", { locale: ptBR }).replace(
            /^./,
            (c) => c.toUpperCase()
          ),
        formatMonthDropdown: (date) =>
          format(date, "MMM", { locale: ptBR }).replace(/^./, (c) =>
            c.toUpperCase()
          ),
        ...formatters,
      }}
      classNames={{
        ...
        today: cn(
          " ext-accent-foreground data-[selected=true]:rounded-full",
          defaultClassNames.today
        ),

        outside: cn(
          "text-muted-foreground aria-selected:text-muted-foreground rounded-full",
